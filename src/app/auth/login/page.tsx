...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const data = await AuthControllerService.login({ email, password });
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    required
                    className="w-full bg-bg-main border border-white/10 p-4 pl-12 pr-12 rounded-xl focus:border-primary outline-none font-bold text-text-main transition-all"
                    placeholder="••••••••"
